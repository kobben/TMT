...
function selectMapAttr(attrib) {
  ...
  if (attrib === "undefined") {
    ...
    TMT.datasettings.dataTitle = "undefined";
    document.getElementById("titleChooser").value = "";
  } else {
    TMT.datasettings.datafield = attrib;
    fillDataViewer(attrib);
    TMT.datasettings.datatitle = attrib.replace(/_/g, " "); // change underscores to spaces
